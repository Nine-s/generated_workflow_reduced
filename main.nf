...
include { STAR_GENOMEGENERATE  } from '/workdir/ninon/description_prototype/rnasplice_modules/star_genome_generate.nf'
include { STAR_ALIGN  } from '/workdir/ninon/description_prototype/rnasplice_modules/star_align.nf'
